    ...
    <>
      ...
      <div className={styles.container}>
        <div className={styles.description}>
          <h1>Sersol Energia Solar</h1>
          <h3>Quem somos</h3>
          <p>A Sersol Energia Solar possui sede no município de Blumenau-SC. É uma empresa especializada em desenvolver, viabiliar e implantar soluções em energia solar fotovoltaica, agregando valor aos seus clientes e contribuindo com a preservação do meio ambiente.</p>
          <p>Nossa atuação busca a sustentabilidade, implantando usinas solares que geram energia limpa e renovável, contribuindo para a redução da emissão de gás carbônico e preservando nossas florestas. Essa atitude responsável pode ser certificada, proporcionando economia financeira para os clientes e atraindo novos parceiros de negócios.</p>
        </div>
        ...
        <div className={styles.mapouter}>
          ...
          <div className={styles.gmap_canvas}><iframe id="gmap_canvas" src="https://maps.google.com/maps?q=sersol%20energia%20solar&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
          </div>
        </div>
      </div>        
    </>
