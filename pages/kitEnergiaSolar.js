        ...
        <>
            ...
            <div className={styles.container}>
                <div className={styles.motivos}>
                    ...
                    <div className={styles.motivos_items}>
                        <h3>Evitar a derrubada de árvores.</h3>
                        <p>Com energia solar você evita a derrubada de árvores ou a queima de combustíveis fósseis, preservando o meio ambiente.</p>
                    </div>
                    <div className={styles.motivos_items}>
                    ...
                    <div className={styles.motivos_items}>
                        <h3>Valoriação do seu imóvel.</h3>
